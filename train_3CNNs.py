...
input_size = (256, 256)
low_res_shape = (684, input_size[0] // 16, input_size[1] // 16)   ####output shape of encoder lowres
high_res_shape = (792, input_size[0] // 8, input_size[1] // 8)    ####output shape of encoder highres
...
gt_train = "./data/gt_split/train_with2014.tsv"
